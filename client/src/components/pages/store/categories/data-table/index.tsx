...
export function CategoriesTable({ columns, data }: Props) {
  ...
  return (
    <>
      ...
      <UpdateCategoryModal open={type === 'update'} onOpenChange={clearRowAction} category={row} />
      <DeleteCategoryModal open={type === 'delete'} onOpenChange={clearRowAction} category={row} />
    </>
  )
}
