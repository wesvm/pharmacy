...
export function SuppliersTable({ columns, data }: Props) {
  ...
  return (
    <>
      ...
      <UpdateSupplierModal open={type === 'update'} onOpenChange={clearRowAction} supplier={row} />
      <DeleteSupplierModal open={type === 'delete'} onOpenChange={clearRowAction} supplier={row} />
    </>
  )
}
